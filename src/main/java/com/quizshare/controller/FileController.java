...
public class FileController {
    ...
    public ResponseEntity<BaseResponse<String>> postUploadFile(
            ...
            @RequestParam(value = "folder_name", required = false, defaultValue = FileStorageService.DEFAULT_UPLOAD_FOLDER) String folderName,
    ...
    /**
     * Upload ảnh lên storage (Cloudinary hoặc local), luôn lưu trong folder {@code images}.
     *
     * Request: multipart/form-data
     *   - file      : file ảnh (jpeg/png/webp)
     *   - file_name : tên file mong muốn (tuỳ chọn — bỏ trống sẽ sinh UUID)
     *
     * Response: { "result": "https://res.cloudinary.com/..." }
     */
    ...
    public ResponseEntity<BaseResponse<String>> uploadImage(
        ...
        String url = fileStorageService.uploadFile(file, FileStorageService.DEFAULT_UPLOAD_FOLDER, fileName);
        return ResponseEntity.ok(BaseResponse.success("Uploaded", url));
    }
